...
train_subjects, remaining_subjects = train_test_split(subj, test_size=0.4, random_state=42)
val_subjects, test_subjects = train_test_split(remaining_subjects, test_size=0.5, random_state=42)
